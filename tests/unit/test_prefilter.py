...
class TestMOG2PreFilter:
    ...
    def test_detects_change(self, blank_frame, frame_with_anomaly_patch):
        ...
        # Introduce a change
        result = pf.process(frame_with_anomaly_patch)
    ...
    def test_reset_clears_background(self, blank_frame, frame_with_anomaly_patch):
        ...
        for _ in range(30):
            pf.process(frame_with_anomaly_patch)
